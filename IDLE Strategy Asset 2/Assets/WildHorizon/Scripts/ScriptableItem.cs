...
// Create -> GFF Idle Game Item. Existing items can be found in the Resources folder.
//
// Note: this class is not abstract so we can create 'useless' items like recipe ingredients, etc.
using System;
...
{
    [CreateAssetMenu(menuName = "Idle clicker strategy Game/General Item", order = 999)]
    public class ScriptableItem : ScriptableObject
    {
        [Header("Base Stats")]
        public uint buyPrice;
        public uint sellPrice;
        public uint shopPrice;
    ...
    [Serializable]
    public struct ScriptableItemAndMinAndMaxAmount
    {
        public ScriptableItem item;
        public uint amountMin;
        public uint amountMax;
    }
}
